/**
 * Intent Router Module for UniCrypt AI.
 * Classifies user query intents to decide which knowledge modes to apply:
 * - GENERAL: Standard AI conversational answers.
 * - PLATFORM: Platform specific Firestore context.
 * - HYBRID: Synthesized external info + internal vault recomendations.
 */
